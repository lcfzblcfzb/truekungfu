...
func _on_to_state(s):
	...
	match s:
		StandarCharactor.CharactorState.Peace:
			...
			sword_sheath.transform = peace_transform
			pass
		StandarCharactor.CharactorState.Engaged:
			...
			sword_sheath.transform = sheath_engaged_transform
			pass
...
func on_add_to_charactor(_charactor:StandarCharactor):
	...
	_charactor.add_to_body(StandarCharactor.CharactorBodySlotEnum.Left_Hand , sword_sheath )
